...
public class UITheme {
    ...
    private UITheme() {} // Verhindert Instanziierung

    // konstanter Buttonstil
    ...
    // konstanter Textfeldstil
    public static JTextField createModernTextField() {
        JTextField tf = new JTextField(20);
        tf.setFont(new Font("SansSerif", Font.PLAIN, 14));
        tf.setBorder(BorderFactory.createCompoundBorder(new LineBorder(COLOR_BORDER, 1), new EmptyBorder(8, 10, 8, 10)));
        return tf;
    }
}